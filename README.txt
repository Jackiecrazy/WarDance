...
- This means that while weight plays a role (49%), the real deal-breaker is health. Defeating an enemy requires wearing down their health to make staggering easier.
- At 0 posture the entity is knocked back and staggered, gaining 1 fracture, binding both hands and slowing movement. The stagger ends after 2 seconds or taking damage once. During this time posture regenerates rapidly and cannot be depleted until it reaches max again.
- Accumulating an attribute-defined quantity of fracture marks instead exposes the entity. In this state the entity cannot do anything, has all four defensive stats negated (absorption, deflection, shatter, armor) negated, and the next hit on it deals an extra 10% of its max health in damage.
...
- After remaining out of combat for a minute, might will be cleared.
...
- Spirit obeys the same rules as posture in regeneration.
...
- Shatter absorbs all damage from a single attack. Period. Fractional shatters will absorb fractional damage. 1 level of shatter will regenerate after 10 seconds of not taking (shatter) damage. Found on crystalline and ceramic armor.
...
- Skills must be first set in the skill screen, then brought up in combat mode with the R key as a radial menu. You have 5 active slots, 4 passive slots, and 1 "style" slot.
