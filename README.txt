...
Clinch: bind both hands on first strike; reversal: exchanges posture by percentage; submission: instantly succeeds if opponent has less armor; throw: pick up enemy and use as projectile; pin: double stagger count for this stagger.
▪ Shield bash:
Kick your shield out as a projectile?
