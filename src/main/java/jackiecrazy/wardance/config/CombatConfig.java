...
public class CombatConfig {
    private static final String[] MOBS = {
            ...
            "atum:brigand, 1.0, 0.0",
            "atum:camel, 1.0, 0.0",
            "atum:desert_rabbit, 1.0, 0.0",
            "atum:nomad, 2.0, 0.5",
            "atum:pharaoh, 1.0, 0.0",
            "atum:quail, 1.0, 0.0",
            "atum:scarab, 1.0, 0.0",
            ...
            "atum:tarantula, 1.0, 0.0",
            "cavesandcliffs:goat, 1.5, 0.33",
            "conjurer_illager:conjurer, 1.6, 0.66",
            "darkerdepths:glowshroom_monster, 0.9, 0.4",
            "dungeons_mobs:armored_drowned, 1.0, 0.4",
            "dungeons_mobs:armored_mountaineer, 1.0, 0.4",
            "dungeons_mobs:armored_piglin, 1.0, 0.4",
            "dungeons_mobs:armored_pillager, 1.0, 0.4",
            "dungeons_mobs:armored_skeleton, 1.0, 0.4",
            "dungeons_mobs:armored_sunken_skeleton, 1.0, 0.4",
            "dungeons_mobs:armored_vindicator, 1.0, 0.4",
            "dungeons_mobs:armored_zombie, 1.0, 0.4",
            "dungeons_mobs:frozen_zombie, 1.5, 0.33",
            "dungeons_mobs:geomancer, 1.2, 0.5",
            "dungeons_mobs:icy_creeper, 1.5, 0.33",
            "dungeons_mobs:illusioner, 1.5, 0.75",
            "dungeons_mobs:illusioner_clone, 2.0, 0.33",
            "dungeons_mobs:mountaineer, 0.9, 0.5",
            "dungeons_mobs:necromancer, 1.4, 0.5",
            "dungeons_mobs:redstone_cube, 1.0, 0.66",
            "dungeons_mobs:redstone_golem, 0.7, 0.75",
            "dungeons_mobs:royal_guard, 0.7, 0.66",
            ...
            "majruszs_difficulty:giant, 1.0, 1.0",
            "majruszs_difficulty:pillager_wolf, 0.9, 0.0",
            "majruszs_difficulty:sky_keeper, 1.0, 0.0",
            "meetyourfight:bellringer, 1.6, 0.33",
            "meetyourfight:dame_fortuna, 1.6, 0.33",
            "meetyourfight:swampjaw, 1.0, 0.0",
            "minecraft:bat, 1.0, 0.0",
            "minecraft:bee, 1.0, 0.0",
            "minecraft:blaze, 1.5, 0.33",
            "minecraft:cave_spider, 1.0, 0.0",
            "minecraft:chicken, 1.0, 0.0",
            "minecraft:cod, 1.0, 0.0",
            "minecraft:cow, 1.0, 0.0",
            "minecraft:creeper, 1.0, 0.0",
            "minecraft:dolphin, 1.0, 0.0",
            "minecraft:donkey, 1.0, 0.0",
            "minecraft:elder_guardian, 0.8, 0.66",
            "minecraft:ender_dragon, 0.6, 0.66",
            "minecraft:evoker, 2.0, 0.33",
            "minecraft:fox, 1.0, 0.0",
            "minecraft:ghast, 1.0, 0.0",
            "minecraft:guardian, 0.9, 0.4",
            "minecraft:hoglin, 1.0, 0.0",
            "minecraft:horse, 1.0, 0.0",
            "minecraft:illusioner, 2.0, 0.4",
            "minecraft:iron_golem, 0.7, 0.75",
            "minecraft:llama, 1.0, 0.0",
            "minecraft:magma_cube, 1.0, 0.0",
            "minecraft:mooshroom, 1.0, 0.0",
            "minecraft:mule, 1.0, 0.0",
            "minecraft:parrot, 1.0, 0.0",
            "minecraft:phantom, 1.0, 0.0",
            "minecraft:pig, 1.0, 0.0",
            "minecraft:piglin_brute, 0.9, 0.33",
            "minecraft:pillager, 1.0, 0.0",
            "minecraft:polar_bear, 1.0, 0.0",
            "minecraft:pufferfish, 1.0, 0.0",
            "minecraft:rabbit, 1.0, 0.0",
            "minecraft:ravager, 1.0, 0.33",
            "minecraft:salmon, 1.0, 0.0",
            "minecraft:sheep, 1.0, 0.0",
            "minecraft:shulker, 0.6, 0.5",
            "minecraft:silverfish, 1.0, 0.0",
            "minecraft:skeleton_horse, 1.0, 0.0",
            "minecraft:slime, 1.0, 0.0",
            "minecraft:spider, 1.0, 0.0",
            "minecraft:squid, 1.0, 0.0",
            "minecraft:strider, 1.0, 0.0",
            "minecraft:trader_llama, 1.0, 0.0",
            "minecraft:tropical_fish, 1.0, 0.0",
            "minecraft:turtle, 1.0, 0.0",
            "minecraft:wandering_trader, 1.0, 0.0",
            "minecraft:wither, 1.0, 0.33",
            "minecraft:zoglin, 1.0, 0.0",
            "minecraft:zombie_horse, 1.0, 0.0",
            "mowziesmobs:baby_foliaath, 1.0, 0.0",
            ...
            "mowziesmobs:ferrous_wroughtnaut, 1.0, 0.0",
            "mowziesmobs:foliaath, 1.0, 0.0",
            "mowziesmobs:grottol, 1.0, 0.0",
            "mowziesmobs:lantern, 1.0, 0.0",
            "mowziesmobs:naga, 1.0, 0.0",
            "mutantbeasts:creeper_minion, 1.0, 0.0",
            "mutantbeasts:endersoul_clone, 2.0, 0.33",
            "mutantbeasts:mutant_creeper, 1.0, 0.0",
            "mutantbeasts:mutant_enderman, 1.5, 0.33",
            "mutantbeasts:mutant_skeleton, 1.0, 0.66",
            "mutantbeasts:mutant_snow_golem, 0.9, 0.5",
            "mutantbeasts:mutant_zombie, 1.0, 0.0",
            "mutantbeasts:spider_pig, 1.0, 0.0",
            "mutantmore:blaze_rod, 1.0, 0.0",
            ...
            "mutantmore:rodling, 1.0, 0.0",
            "mysticalworld:beetle, 1.0, 0.0",
            "mysticalworld:deer, 1.0, 0.0",
            "mysticalworld:duck, 1.0, 0.0",
            "mysticalworld:frog, 1.0, 0.0",
            "mysticalworld:hell_sprout, 1.0, 0.0",
            "mysticalworld:lava_cat, 1.0, 0.0",
            "mysticalworld:owl, 1.0, 0.0",
            "mysticalworld:silkworm, 1.0, 0.0",
            "mysticalworld:silver_fox, 1.0, 0.0",
            "mysticalworld:sprout, 1.0, 0.0",
            "outer_end:chorus_squid, 1.0, 0.0",
            "outer_end:entombed, 0.8, 0.66",
            "outer_end:himmelite, 1.2, 0.5",
            "outer_end:purpur_golem, 0.7, 0.8",
            "outer_end:spectrafly, 1.0, 0.0",
            "outer_end:stalker, 1.0, 0.0",
            "quark:crab, 1.0, 0.0",
            "quark:frog, 1.0, 0.0",
            "quark:shiba, 1.0, 0.0",
            "quark:stoneling, 0.8, 0.25",
            "quark:toretoise, 0.8, 0.66",
            "savageandravage:creepie, 1.0, 0.0",
            "savageandravage:griefer, 1.0, 0.0",
            "savageandravage:iceologer, 1.0, 0.0",
    ...
    public CombatConfig(ForgeConfigSpec.Builder b) {
        ...
        _customParry = b.translation("wardance.config.parryMobs").comment("Define mobs that are automatically capable of parrying. If the entity is simultaneously armed and capable of parry, the lowest multiplier will be chosen. Format is name, defense posture multiplier, parry chance. Hands are individually calculated for chance. Filling in a negative parry multiplier will disable parrying regardless of weaponry with the defined chance.").defineList("auto parry mobs", Arrays.asList(MOBS), String.class::isInstance);
