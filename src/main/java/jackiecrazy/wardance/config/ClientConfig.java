...
public class ClientConfig {
    ...
    public ClientConfig(ForgeConfigSpec.Builder b) {
        ...
        b.pop();
        b.push("yours");
        _yourPostureX = b.translation("wardance.config.uPosX").comment("your posture bar X, defined as deviation from the center").defineInRange("yourPostureX", 0, 0, Integer.MAX_VALUE);
        ...
        b.pop();
        b.push("theirs");
        _theirPostureX = b.translation("wardance.config.tPosX").comment("enemy posture bar X, defined as deviation from the center").defineInRange("theirPostureX", 0, 0, Integer.MAX_VALUE);
