...
public class TemporaryMoveTranslator {
    ...
    public static void scheduleFinisher(LivingEntity e,
                                        ...
                                        WeaponInteractions.SweepAttack base) {
        final WeaponInteractions.HitInfo preFinish = base.preFinishCopy().getHitInfo();
        final WeaponInteractions.HitInfo finish = base.finisherCopy(CombatData.getCap(e).consumeSpirit(CombatData.getCap(e).getMaxSpirit())).getHitInfo();
        CombatData.getCap(e).setSpirit(CombatData.getCap(e).getMaxSpirit());
        ...
        switch (base.getType()) {
            case CONE -> {
                ...
                FlyingWeaponData.getCap(e).scheduleAction(hand, temp_getMMFromType(3, WeaponInteractions.SweepAttack.SWEEPTYPE.CONE, base.getBase() + 3 * base.getScaling()), preFinish, range, 10, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
                FlyingWeaponData.getCap(e).scheduleAction(hand, temp_getMMFromType(15, WeaponInteractions.SweepAttack.SWEEPTYPE.LINE, 3), finish, range+2, 20, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
            }
            case CLEAVE -> {
                //tcs
                FlyingWeaponData.getCap(e).scheduleAction(hand, new MotionManagers.DefinitionMM(new MotionGroup(LOOP, EasingFunction.IN_CUBIC, 20)), finish, range, 9, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
            }
            case IMPACT -> {
                //spin and slam down
                FlyingWeaponData.getCap(e).scheduleAction(hand, temp_getMMFromType(15, WeaponInteractions.SweepAttack.SWEEPTYPE.CIRCLE, base.getBase() + 3 * base.getScaling()), preFinish, range, 9, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
                FlyingWeaponData.getCap(e).scheduleAction(hand, temp_getMMFromType(20, WeaponInteractions.SweepAttack.SWEEPTYPE.CLEAVE, 60), finish, range, 9, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
            }
            case CIRCLE -> {
                //beeeeeg circle
                FlyingWeaponData.getCap(e).scheduleAction(hand, temp_getMMFromType(40, WeaponInteractions.SweepAttack.SWEEPTYPE.CIRCLE, base.getBase() + 3 * base.getScaling()), finish, range+2, 9, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
            }
            case LINE -> {
                //triple jab followed by big jab
                FlyingWeaponData.getCap(e).scheduleAction(hand, temp_getMMFromType(3, WeaponInteractions.SweepAttack.SWEEPTYPE.LINE, base.getBase() + 3 * base.getScaling()), preFinish, range, 3, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
                FlyingWeaponData.getCap(e).scheduleAction(hand, temp_getMMFromType(5, WeaponInteractions.SweepAttack.SWEEPTYPE.LINE, base.getBase() + 3 * base.getScaling()), preFinish, range, 3, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
                FlyingWeaponData.getCap(e).scheduleAction(hand, temp_getMMFromType(10, WeaponInteractions.SweepAttack.SWEEPTYPE.LINE, base.getBase() + 3 * base.getScaling()), finish, range+2, 5, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
            }
            case NONE -> {
                //flurry of blows
                FlyingWeaponData.getCap(e).scheduleAction(hand, temp_getMMFromType(3, WeaponInteractions.SweepAttack.SWEEPTYPE.LINE, base.getBase() + 3 * base.getScaling()), preFinish, range, 3, FlyingWeaponEffect.TRAIL, FlyingWeaponEffect.WEAPON, FlyingWeaponEffect.BIG_SHADOW);
    ...
    public static MotionManager temp_getMMFromType(int time, WeaponInteractions.SweepAttack.SWEEPTYPE type, double area) {
