...
public class WarActionsRegistry {
    ...
    public static final RegistryObject<ActionType> LOAD_ITEM = ACTIONS.register("load_item", () -> (a) -> WeaponInteractions.NAIVE.fromJson(a, LoadItemAction.class));
    public static final RegistryObject<ActionType> PLAY_INTERACTION = ACTIONS.register("play_interaction", () -> (a) -> WeaponInteractions.NAIVE.fromJson(a, PlayInteractionAction.class));
