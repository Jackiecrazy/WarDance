...
public class WarDanceCommand {
    ...
    private static int stagger(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        if (!(player instanceof LivingEntity)) throw EntityOptions.INAPPLICABLE_ENTITY_OPTION.create(player);
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.command.stagger", player.getDisplayName(), time, count), false);
    ...
    private static int defaultStagger(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.staggerDefault", player.getDisplayName(), time), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int setMight(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.setMight", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int consumeMight(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.conMight", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int addMight(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.addMight", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int getMight(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.getMight", player.getDisplayName(), might), false);
    ...
    private static int setSpirit(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.setSpirit", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int consumeSpirit(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.conSpirit", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int addSpirit(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.addSpirit", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int getSpirit(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.getSpirit", player.getDisplayName(), spirit), false);
    ...
    private static int setPosture(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.setPosture", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int consumePosture(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.conPosture", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int addPosture(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.addPosture", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int getPosture(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.getPosture", player.getDisplayName(), posture), false);
    ...
    private static int setWounding(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.setWounding", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int consumeWounding(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.conWounding", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int addWounding(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        float i = FloatArgumentType.getFloat(ctx, "amount");
        CombatData.getCap((LivingEntity) player).addWounding(i);
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.addWounding", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int getWounding(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.getWounding", player.getDisplayName(), wounding), false);
    ...
    private static int setFatigue(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.setFatigue", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int consumeFatigue(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.conFatigue", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int addFatigue(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        float i = FloatArgumentType.getFloat(ctx, "amount");
        CombatData.getCap((LivingEntity) player).addFatigue(i);
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.addFatigue", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int getFatigue(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.getFatigue", player.getDisplayName(), fatigue), false);
    ...
    private static int setBurnout(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.setBurnout", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int consumeBurnout(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.conBurnout", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int addBurnout(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        float i = FloatArgumentType.getFloat(ctx, "amount");
        CombatData.getCap((LivingEntity) player).addBurnout(i);
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.addBurnout", player.getDisplayName(), i), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int getBurnout(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.getBurnout", player.getDisplayName(), burnout), false);
    ...
    private static int setSkill(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.setSkill"+(CasterData.getCap(player).isSkillSelectable(skill)), player.getDisplayName(), skill.getDisplayName(null)), false);
        return Command.SINGLE_SUCCESS;
    }
    ...
    private static int getSkill(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.getSkill"+(CasterData.getCap(player).isSkillSelectable(skill)), player.getDisplayName(), skill.getDisplayName(null)), false);
        return enabled ? 1 : 0;
    }
    ...
    private static int resetSkills(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        ctx.getSource().sendFeedback(new TranslationTextComponent("wardance.command.clearSkill"+(player.world.getGameRules().getBoolean(WarDance.GATED_SKILLS)), player.getDisplayName()), false);
        return Command.SINGLE_SUCCESS;
    }
